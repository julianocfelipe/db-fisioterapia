...
/**
 * THE FOLLOW CODE HAS BEEN CREATED BY:
 * https://trevoratlas.com/posts/how-to-create-a-typescript-singleton-decorator
 *
 * THIS IS BASICALLY A SINGLETON DECORATOR
 * HOW TO USE:
 * INSERT @Singleton BESIDES A CODE AND BE HAPPY
 */
...
const singletonDecorator = <T extends new (...args: any[]) => any>(type: T) =>
  new Proxy(type, {
